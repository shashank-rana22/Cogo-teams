export function ExtraHardCodeData() {
	return (
		<>
			...
			<div style={{ fontSize: '12px', marginTop: '28px', fontWeight: '600' }}>
				PENALTY SLABS FOR LATE COLLECTION OF DELIVERY ORDER
			</div>
			<div style={{ fontSize: '12px', marginTop: '4px' }}>
				Upto14 days : No fine (starting from the devanning date).
			</div>
			<div style={{ fontSize: '12px' }}>Between 15-30 days: Rs.1500/BL</div>
			<div style={{ fontSize: '12px' }}>Between 31-60 days: Rs.2500/BL</div>
			<div style={{ fontSize: '12px' }}>Above 61 days: Rs.6000/BL</div>

			<div style={{ fontSize: '12px', marginTop: '40px', fontWeight: '600' }}>
