...
export default {
	country: {
		...
		name          : 'Indonesia',
		code          : 'ID',
		flag_icon_url : 'https://prod-cogoport.s3.ap-south-1.amazonaws.com/Indonesia_24.png',
		currency      : {
			code   : 'IDR',
			symbol : 'Rp',
		},
	...
	regex: {
		...
		ECN                                : '',
		MOBILE_NUMBER                      : /^(?:(?:\+62)|(?:62)|0)(?:8[1-9]\d{7,10}|8[1-9]\d{1,2}|\d{2,3})$/,
	...
	uuid             : {
      ...
      '2c72817c-c663-48ea-b8ef-cd92397842a1',
		...
		cogo_one_admin_ids    : [
			...
			'9d940453-bcfc-47c1-9cc7-be1996e89dc0', // SuperAdmin
		],
		...
		finance_head             : [
			'a8a175c5-fec2-4c08-8e6b-0fb5c7951c86',
			'635658c1-8d6b-4ab5-83a4-bd4989287193',
		],
		so1_revenue_desk: [
			'348bc262-64c3-4667-a23c-908ceca80233',
