	...
	business_finance: {
		...
		options   : [
			...
			},
			{
				...
				title         : 'AR - Translate',
				href          : '/business-finance/translate-account-receivables/[active_tab]',
				as            : '/business-finance/translate-account-receivables/pending',
				type          : 'link',
				main_apis     : [],
				possible_apis : apis.translate_account_receivables,
			},
		],
		module_type: 'dashboards',
	},
