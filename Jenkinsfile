    ...
    stages {
        ...
        stage('Deploy') {
            ...
            post {
                ...
                failure {
                    office365ConnectorSend webhookUrl: "${TEAMS_WEBHOOK_URL}", message: "## Deployment failed for commit *${COMMIT_ID}* of branch **${BRANCH_NAME}** on server ${SERVER_NAME}", color: '#ff0000'
                }
            }
