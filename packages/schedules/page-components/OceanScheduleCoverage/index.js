...
function OceanScheduleCoverage() {
	...
	const {columns,columnsForPattern,columnsForPortToPort} = getColumns({setOriginPort,setDestinationPort,setIsPortToPort,setShow});
	return (
	<>
		{ !isPortToPort && (<>
		...
		{ isPortToPort && (<>
			<OSCPortToPort originPort={originPort} 
