...
const useUploadCargoArrivalForm = ({
	...
	const createShipmentTradeDoc = useRequest(
		'post',
		false,
		'partner',
	...
	const movement_details =
		summary?.movement_details || summary?.movement_detail || [];
	...
	const handleSubmitDocument = async () => {
		...
		try {
			const res = await createShipmentTradeDoc.trigger({ data: body });
	...
	return {
		...
		loading: createShipmentTradeDoc.loading,
	};
};
