import { Button, Select, Modal } from '@cogoport/components';
import GLOBAL_CONSTANTS from '@cogoport/globalization/constants/globals';
import { IcMTick, IcMArrowRight } from '@cogoport/icons-react';
...
function ProductDetails({
	...
	loading = false, currency_symbol = '', size_chart = [],
}) {
	const [openModal, setOpenModal] = useState(false);
	const [firstimg, secondimg] = size_chart || [];
	...
	return (
		<>
				...
				<div className={styles.header}>
					...
					<div className={styles.product_details}>
						...
						<div className={styles.product_filters}>
							...
							<div className={styles.product_filter_item_1}>
								<div style={{
									display        : 'flex',
			...
			{openModal && (
				<Modal size="md" show={openModal} onClose={() => setOpenModal(false)} placement="center">
					<Modal.Header title="Size Chart" />
					<Modal.Body>
						<img src={firstimg} alt="size chart" className={styles.chart_img} />
						<img src={secondimg} alt="size chart" className={styles.chart_img} />
