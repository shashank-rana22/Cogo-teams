export const COMMODITY_NAME_MAPPING = {
	general: {
		name: 'General', description: '', is_reefer: false, is_haz: false,
	},
	hazardous: {
		name: 'Hazardous', description: '', is_reefer: false, is_haz: true,
	},
	white_goods: {
		name: 'White Goods', description: '', is_reefer: false, is_haz: false,
	},
	pta: {
		name: 'PTA', description: '', is_reefer: false, is_haz: false,
	},
	cotton_and_yarn: {
		name: 'Cotton and yarn', description: '', is_reefer: false, is_haz: false,
	},
	fabric_and_textiles: {
	...
	sugar_rice: {
		name: 'Sugar Rice', description: '', is_reefer: false, is_haz: false,
	},
	chilled: {
		name: 'Chilled', description: '', is_reefer: true, is_haz: false,
	},
	frozen: {
		name: 'Frozen', description: '', is_reefer: true, is_haz: false,
	},
	pharma: {
		name: 'Pharma', description: '', is_reefer: true, is_haz: false,
	},
	in_gauge_cargo: {
		name: 'In Gauge Cargo', description: '', is_reefer: false, is_haz: false,
	},
	non_haz_solids: {
	...
	non_haz_gases: {
		name: 'Non Hazardous Gases', description: '', is_reefer: false, is_haz: false,
	},
	'gases-2.1': {
		name: 'Gases 2.1', description: '', is_reefer: false, is_haz: true,
	},
	'gases-2.2': {
		name: 'Gases 2.2', description: '', is_reefer: false, is_haz: true,
	},
	'gases-2.3': {
		name: 'Gases 2.3', description: '', is_reefer: false, is_haz: true,
	},
	'flammable_liquids-3': {
	...
	'imo_classes-5.1': {
		name: 'IMO Classes 5.1', description: '', is_reefer: false, is_haz: true,
	},
	...
	'corrosives-8': {
		name: 'Corrosives 8', description: '', is_reefer: false, is_haz: true,
	},
	...
	express: {
		name: 'Express', description: '', is_reefer: false, is_haz: false,
	},
	perishable: {
		name: 'Perishable', description: '', is_reefer: false, is_haz: false,
	},
	live_animals: {
		name: 'Live animals', description: '', is_reefer: false, is_haz: false,
	},

	fmcg: {
		name: 'FCMG', description: '', is_reefer: false, is_haz: false,
	},
...
const ISO_TANK_COMMODITIES = ['non_haz_solids', 'non_haz_liquids', 'non_haz_gases'];
...
export const AIR_STANDARD_COMMODITIES = ['general', 'perishable', 'live_animals', 'pharma'];

export const AIR_HAZARDOUS_COMMODITIES = ['hazardous'];

export const AIR_LOCAL_COMMODITIES = [...AIR_STANDARD_COMMODITIES, ...AIR_HAZARDOUS_COMMODITIES];
...
export const ALL_FCL_COMMODITIES = [FAK_COMMODITY, ...STANDARD_COMMODITIES, ...HAZ_CLASSES];
