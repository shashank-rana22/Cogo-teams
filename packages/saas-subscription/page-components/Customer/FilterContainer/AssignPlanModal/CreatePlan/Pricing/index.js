...
const Pricing = ({ configs, item = [], loading = false,setUpdatePricing=()=>{} ,setFrequencyPeriod=()=>{}}) => {
	const [isEditPrice, setIsEditPrice] = useState(true);
	const itmFn = itemFunction({ isEditPrice, setIsEditPrice,setUpdatePricing,setFrequencyPeriod });
	return (
		configs.map((config) => (
			<div
