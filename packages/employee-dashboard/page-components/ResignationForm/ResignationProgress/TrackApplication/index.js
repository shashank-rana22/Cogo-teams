...
function TrackApplication({ data = {} }) {
	...
	const applicationStatusStepper = useCallback((dataset = {}) => {
		...
		// 	}
		// }
		// console.log('key set to find :: ',
		// Object.entries(dataset?.process_status).find((element) => element[1].status !== 'completed'));
	}, []);
