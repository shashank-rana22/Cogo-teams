...
function EngagementType(props) {
	...
	return (
		<div className={styles.collapse_inner_container}>
			...
			) : <Table className={styles.table_container} columns={tableColumns} data={sub_list} />}
