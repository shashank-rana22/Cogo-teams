...
const items = [
	'Opening test instructions during the test will lead to wastage of test time, make sure you read instructions well before beginning the test.',
...
function InstructionsModal({ loading, guidelines, setShowInstructionsModal }) {
	...
	return (
		<Modal showCloseIcon={false} size="md" show className={styles.modal_container}>
			...
			<Modal.Body>
				<div className={styles.modal_body}>The timer still on, no extra time will be given for reading the instructions during the test.</div>
