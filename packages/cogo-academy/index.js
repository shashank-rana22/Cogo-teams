export { default as ControlCenter } from './page-components/CreateFAQ';
export { default as FAQs } from './page-components/FAQs';
export { default as ConfigurationEngine } from './page-components/CreateFAQ/ConfigurationEngine';
