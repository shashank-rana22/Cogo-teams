...
const INVOICE_CURRENCY_MAPPINGS = {
	freight_invoice_currency: {
		[getCountryCode(GLOBAL_CONSTANTS.country_entity_ids.IN)]: [
			GLOBAL_CONSTANTS.currency_code.INR,
			GLOBAL_CONSTANTS.currency_code.USD,
		],
		[getCountryCode(GLOBAL_CONSTANTS.country_entity_ids.GB)]: [
			GLOBAL_CONSTANTS.currency_code.GBP,
			GLOBAL_CONSTANTS.currency_code.EUR,
			GLOBAL_CONSTANTS.currency_code.USD,
		],
		[getCountryCode(GLOBAL_CONSTANTS.country_entity_ids.VN)]: [
			GLOBAL_CONSTANTS.currency_code.USD,
