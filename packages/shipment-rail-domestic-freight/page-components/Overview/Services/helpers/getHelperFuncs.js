...
const tradeTypeBasedServiceType = {
	import   : 'rail_domestic_import',
	export   : 'rail_domestic_export',
	domestic : 'rail_domestic',
};
...
const classifyTradeTypeBasedService = ({
	...
	const matchingService = servicesList.find((service) => {
		...
		return service_type === serviceType && (trade_type === tradeType
			|| serviceType === 'rail_domestic_freight_service');
	});
