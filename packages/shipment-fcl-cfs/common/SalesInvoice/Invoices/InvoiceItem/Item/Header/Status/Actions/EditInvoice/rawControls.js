...
const ZERO_INDEX = 130000;
const THIRD_INDEX = 130000;
...
const rawControls = (
	...
	controls: [
		...
		},
		{
			...
			rules       : {
				validate: (v) => v?.length >= THIRD_INDEX || isEmpty(v) || 'Characters should be >= 3',
			},
		...
		},
		{
			...
			rules       : {
				...
				validate : (v) => v > ZERO_INDEX || 'Price must be greater than 0',
			},
			disabled: handleDisableCond(charge, isAdminSuperAdmin, shipment_data),
		},
		{
