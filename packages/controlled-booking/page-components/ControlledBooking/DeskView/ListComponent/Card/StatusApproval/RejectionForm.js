		...
		<>
			...
			<div className={styles.form_element}>
				...
				{errors?.rejection_category
					? <div className={styles.error_message}>{errors?.rejection_category.message}</div> : null}
			</div>
			...
			<div className={styles.form_element}>
				...
				{errors?.rejection_reason
					? <div className={styles.error_message}>{errors?.rejection_reason.message}</div> : null}
			</div>
		</>
	);
}
