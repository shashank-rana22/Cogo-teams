...
const API_MAPPING = {
	...
	fcl_freight_local : 'delete_fcl_freight_rate_local_feedback',
	air_freight_local : 'delete_air_freight_rate_local_feedback',
};
...
const KEY_TO_SEND = {
	...
	fcl_freight_local : 'fcl_freight_rate_local_feedback_ids',
