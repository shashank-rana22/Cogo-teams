		...
		try {
			await triggerSystemData({
				params: {
					...
					origin_main_port_id      : selectedRate?.origin_main_port_id ? selectedRate?.origin_main_port_id : undefined,
					destination_main_port_id : selectedRate?.destination_main_port_id ? selectedRate?.destination_main_port_id : undefined,
					...
					shipping_line_id         : selectedRate?.shipping_line_id ? selectedRate?.shipping_line_id : undefined,
					importer_exporter_id     : selectedRate?.importer_exporter_id ? selectedRate?.importer_exporter_id : undefined,
