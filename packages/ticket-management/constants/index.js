...
export const sortByOptions = ({ t }) => [
	...
	{ label: t('myTickets:unread_message'), value: 'unread_message' },
];
...
export const FETCH_API_FOR_REQUEST = ['shipment', 'feedback', 'platform_issue'];
export const CATEGORY_SID_TYPES = ['shipment', 'shipment bookings'];
