...
// import TrucksDetails from '@cogo/bookings/ShipmentDetails/commons/TrucksDetails';
// import {
// 	formatValue,
// 	getTrucklistWithId,
// 	getEtaEtdList,
// } from '@cogo/bookings/ShipmentDetails/commons/TrucksDetails/formatValue';
// import EditTruckNumberETA from '../../../TrucksDetails/UpdateTruckNumberETA';
import styles from '../styles.module.css';

const TruckDetailCards = ({
	primary_service,
	shipment_data,
	className,
	refetch = () => {},
	...
	const disableEdit = notAllowedStakeHolders.some((obj) =>
		stakeholder_types.includes(obj),
	);
