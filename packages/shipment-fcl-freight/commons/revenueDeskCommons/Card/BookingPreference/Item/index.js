		...
		${isLast ? cl.ns('isLast') : ' '}`}>
			...
			<div className={styles.flexCol}>
				{data?.map((item, index) => {
					...
					const {is_rate_expired, is_reverted_rate, columns} = getFormattedSupplierData(bookingItem, index, source);

					return (
						<div className={styles.flexRow}>
							<div className={cl`${styles.flexWrapper}
		${is_reverted_rate ? cl.ns('reverted') : ' '}`}>
								Supplier Booking(
