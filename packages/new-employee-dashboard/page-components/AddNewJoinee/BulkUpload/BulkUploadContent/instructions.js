const INSTRUCTIONS = {
	create: [
		'1. Personal Email/Cogoport Email should be unique and not have any preceding or following spaces.',
		'2. Mobile Country Code should include a "+" sign.',
		...
		'9. Learning Indicator should be one of the following:',
		'10. The value of Attendance should be either "flexi_shift" or "geo_location".',
	],
	update: [
