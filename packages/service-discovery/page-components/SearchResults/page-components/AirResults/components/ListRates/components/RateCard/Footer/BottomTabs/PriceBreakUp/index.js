...
function IndividualPriceBreakup({ service = {}, restServiceDetail = {} }) {
	...
	const containerDetail = getDetails({ item: restServiceDetail });
...
function PriceBreakup({ rate = {}, detail = {} }) {
	const { service_rates = {}, total_price_discounted = 0, total_price_currency = '' } = rate;
