...
const getPrefillForm = ({ load_details = {}, setValue = () => {} }) => {
	const {
		search_type = '',
		service_details = {},
		cargo_readiness_date: ftl_cargo_readiness_date = '',
		commodity: ftl_commodity = '',
		commodity_type: ftl_commodity_type = '',
		load_selection_type: ftl_load_selection_type = '',
	} = load_details;

	const load = getLoadArray(search_type, service_details);
