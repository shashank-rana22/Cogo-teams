...
import { PortPairsEnterpriseShipmentSection,PromisedConAndContract } from '../../../configuration/customer-past-month-data-card';
	...
	return (
		<div className={styles.container}>
            ...
            <div className={styles.port_pairs_section}>
                <div className={styles.tag_prefix_name}>{PortPairsEnterpriseShipmentSection.port_pairs} Port Pairs :</div>
                <div className={styles.tag_suffix_name}>{PortPairsEnterpriseShipmentSection.requested_for_approval} Requested For Approval</div>
            </div>
            ...
            <div className={styles.last_shipment_section}>
                ...
                <div className={styles.tag_suffix_name}>{PortPairsEnterpriseShipmentSection.last_shipment} Ago</div>
            </div>
            ...
            <div className={styles.revenue_profitability_utilisation_section}>
                {PromisedConAndContract.map((item)=>(
                    <div className={styles.individual_section}>
                        ...
                        <div className={`${styles.revenyue_profitability_utilization_value} ${styles[item.color]}`}>{item.value}</div>
                    </div>
                ))}
            </div>
		</div>
