...
const CostSheet = () => {
    ...
    const { tentativeProfit: preTaxActual, quotationalProfit: preTaxExpected } =
        preTaxData || {};
    const {
        tentativeProfit: postTaxActual,
        quotationalProfit: postTaxExpected,
    } = postTaxData || {};
    ...
    return (
        <div>
            <div className={styles.flex}>
                ...
                <div className={styles.flexwidth}>
                    ...
                    <Button
                        size="md"
                        themeType="primary"
                        disabled={!showButton || FinalLoading}
                        onClick={() => {
                            getFinalData();
                        }}
                    >
            ...
            <DiscountRect
                ...
                statvalue="KAM - INR 30,000"
                statlabel="Revenue Desk - INR 30,000"
            />
            <Accordion
                type="text"
                title={
                ...
                title={
                    (
                        <span className={styles.details}>
                            Shipment Details{" "}
                            <div className={styles.shipmentag}>Export</div>
                        </span>
                    ) as unknown as string
                }
                style={{
            ...
            <div className={styles.flexresponsive}>
                <div className={styles.displayflex}>
                    <DiscountRect
                        heading={
                            <span className={styles.legends}>Legends</span>
                        }
                        statlabel={
