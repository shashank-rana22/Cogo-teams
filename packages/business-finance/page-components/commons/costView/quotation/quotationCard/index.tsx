				...
				({ service_type = '', id = '', line_items = [] }) => (
					<div key={id}>
						<div className={styles.mainContainer}>
							<div className={styles.flex}>
								<b style={{ color: '#333333', fontSize: '20px' }}>
									{service_type}
								</b>
							</div>
						</div>
						...
						{line_items.map((serviceItem:LineItems) => {
							const {
								name = '',
								code = '',
								tax_total_price_discounted:taxTotalPriceDiscounted = 0,
							...
							return (
								...
								>
									...
									<div className={styles.customFlex}> 
										{showPrice(
											taxTotalPriceDiscounted || taxTotalPrice,
											currency || 'INR',
										)}
									</div>

									<div className={styles.customFlex}>
										{showPrice(actualPrice, actualPriceCurrency || 'INR')}
									</div>
								</div>
							);
						})}
