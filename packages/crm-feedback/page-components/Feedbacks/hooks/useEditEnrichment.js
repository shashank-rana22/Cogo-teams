...
const useEditEnrichment = ({ checkedRowsId = [] }) => {
	...
	const onEditEnrichmentRequest = async () => {
		// try {
		// 	const payload = {
		// 	};
		...
		onCloseModal();
		Toast.success('onEditEnrichmentRequest has been called, checkedRowsId are in console.');
	};
...
export default useEditEnrichment;
